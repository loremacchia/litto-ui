"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_tiptap_core_dist_tiptap-core_esm_js"],{
...
/* harmony export */ });
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-state */ 1976);
/* harmony import */ var prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-transform */ 9687);
/* harmony import */ var prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prosemirror-commands */ 3121);
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! prosemirror-model */ 85734);
/* harmony import */ var prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! prosemirror-schema-list */ 45882);
/* harmony import */ var prosemirror_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! prosemirror-view */ 23697);
/* harmony import */ var prosemirror_keymap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! prosemirror-keymap */ 79395);
...
function resolveFocusPosition(doc, position = null) {
  ...
  if (position === 'start' || position === true) {
    return prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.Selection.atStart(doc);
  }

  if (position === 'end') {
    return prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.Selection.atEnd(doc);
  }

  if (position === 'all') {
    return prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection.create(doc, 0, doc.content.size);
  ...
  return prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection.create(doc, resolvedFrom, resolvedEnd);
}
...
const splitBlock = ({
  ...
  if (dispatch) {
    ...
    if (!types && !can && (0,prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__.canSplit)(tr.doc, tr.mapping.map($from.pos), 1, deflt ? [{
      type: deflt
    }] : undefined)) {
      can = true;
      types = deflt ? [{
...
const splitListItem = typeOrName => ({
  ...
  if ($from.parent.content.size === 0 && $from.node(-1).childCount === $from.indexAfter(-1)) {
    ...
    if (dispatch) {
      let wrap = prosemirror_model__WEBPACK_IMPORTED_MODULE_3__.Fragment.empty; // eslint-disable-next-line
...
const joinListBackwards = (tr, listType) => {
  ...
  const canJoinBackwards = list.node.type === (nodeBefore === null || nodeBefore === void 0 ? void 0 : nodeBefore.type) && (0,prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__.canJoin)(tr.doc, list.pos);
...
const joinListForwards = (tr, listType) => {
  ...
  const canJoinForwards = list.node.type === (nodeAfter === null || nodeAfter === void 0 ? void 0 : nodeAfter.type) && (0,prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__.canJoin)(tr.doc, after);
...
function getHTMLFromFragment(fragment, schema) {
  const documentFragment = prosemirror_model__WEBPACK_IMPORTED_MODULE_3__.DOMSerializer.fromSchema(schema).serializeFragment(fragment);
...
class Editor extends EventEmitter {
  ...
  createView() {
    ...
    this.view = new prosemirror_view__WEBPACK_IMPORTED_MODULE_5__.EditorView(this.options.element, { ...this.options.editorProps,
...
function wrappingInputRule(config) {
  return new InputRule({
    ...
    handler: ({
      ...
      if (before && before.type === config.type && (0,prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__.canJoin)(tr.doc, range.from - 1) && (!config.joinPredicate || config.joinPredicate(match, before))) {
...
function generateJSON(html, extensions) {
  ...
  return prosemirror_model__WEBPACK_IMPORTED_MODULE_3__.DOMParser.fromSchema(schema).parse(dom).toJSON();
}
...
/* harmony export */ });
/* harmony import */ var prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-transform */ 9687);
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-model */ 85734);
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prosemirror-state */ 1976);
...
/* harmony export */ });
/* harmony import */ var w3c_keyname__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! w3c-keyname */ 19519);
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-state */ 1976);
...
/* harmony export */ });
/* harmony import */ var orderedmap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! orderedmap */ 75005);
...
/* harmony export */ });
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-model */ 85734);
/* harmony import */ var prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-transform */ 9687);
...
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-state */ 1976);
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-model */ 85734);
/* harmony import */ var prosemirror_transform__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prosemirror-transform */ 9687);
...
//# sourceMappingURL=node_modules_tiptap_core_dist_tiptap-core_esm_js.js.map