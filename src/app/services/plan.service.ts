...
export class PlanService {
  ...
  getPlan(planId: string): Observable<Plan> {
    return this.http
      .get<Plan>(this.baseUrl + '/plan/' + planId, this.httpOptions)
  ...
  startPlan(
    ...
    return this.http
      .post(
        this.baseUrl + '/user/' + userId + '/start/' + plan.id + '',
        JSON.stringify({ dateFrom: from, dateTo: to }),
        this.httpOptions
      )
  ...
  createPlan(
    userId: string,
    newPlan: { [key: string]: any }
  ): Observable<string> {
    return this.http
      .post(
        this.baseUrl + '/plan/create/' + userId,
        newPlan,
        this.httpOptions
      )
  ...
  getActiveStep(userId: string, planId: string): Observable<Step> {
    return this.http
      .get(this.baseUrl + '/step/' + userId + '/' + planId, this.httpOptions)
  ...
  completeStep(
    ...
    return this.http
      .get(
        this.baseUrl + '/step/' + userId + '/' + planId + '/next/' + planWeek,
        this.httpOptions
      )
